...
Le fichier init.json ne contient donc pas de données json brut mais une variable JS contenant les données json. (Problèmes de cross domaine vu que le fichier est ouvert en local).
